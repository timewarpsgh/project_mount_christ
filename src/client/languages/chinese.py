dic = {
    ...
    'From the deck of our ship, we beheld a most fearsome spectacle—Mount Vesuvius, that towering giant of fire and rock, erupted with a fury unseen. A great plume of smoke, thick and black as night, billowed into the sky, twisting and turning like a serpent of smoke and flame. The air grew heavy, and the winds carried a foul scent of sulfur as ash began to rain down upon the sea. The mount itself was ablaze, with streams of molten lava coursing down its flanks, glowing like molten gold in the dimming light. The very sea seemed unsettled, waves rippling unnaturally as if disturbed by the wrath of the earth beneath. A terrible rumble shook the ship, and for a moment, it seemed the entire world might fall into chaos.': '从我们的甲板上，我们目睹了一幕最可怕的景象——维苏威火山，那座由火焰和岩石构成的巨人，以前所未有的愤怒喷发。一股浓烟，像黑夜一样浓黑，翻滚着升入天空，像一条烟与火的蛇一样扭曲盘旋。空气变得沉重，风带着硫磺的恶臭，灰烬开始像雨一样落在海面上。火山本身在燃烧，熔岩流从它的侧面流淌而下，在暗淡的光线中像熔化的黄金一样闪耀。大海似乎也不安，波浪不自然地起伏，仿佛被地下的愤怒所扰动。一阵可怕的轰鸣震动了船只，一时间，整个世界似乎都可能陷入混乱。',
